...
int main() {
    ...
    // should return NULL
    src = "";
    result = bt_base32_decode ( ctx, src, strlen ( src ), &result_length );
    if ( result ) {
        talloc_free ( ctx );
        return 2;
    }
    ...
    src = "BGQHKHR56P6J32HGQTCCHFIA7UTHWEF6";
    result = bt_base32_decode ( ctx, src, strlen ( src ), &result_length );
    ...
    // should return NULL
    src = "";
    result = bt_base64_decode ( ctx, src, strlen ( src ), &result_length );
    if ( result ) {
        talloc_free ( ctx );
        return 9;
    }
    ...
    src = "7018b750d7be55ba6b05aca43dfea14c85502225";
    result = bt_base64_decode ( ctx, src, strlen ( src ), &result_length );
